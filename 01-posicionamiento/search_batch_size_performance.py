...
from lib.trainingcommon import load_real_track_data, plot_learning_curves, load_history
...
for batch_size in batch_sizes:
    ...
    scaler_file = model_dir+'/files/batch_size_search/'+model_name+'/scaler_'+windowsettings_suffix+'_bs'+batch_size_str+'.pkl'
    model_file = model_dir+'/files/batch_size_search/'+model_name+'/model_'+windowsettings_suffix+'_bs'+batch_size_str+'.tf'
    history_file = model_dir+'/files/batch_size_search/'+model_name+'/history_'+windowsettings_suffix+'_bs'+batch_size_str
    output_dir = script_dir+'/prediction_output/batch_size_search/'
    output_file = output_dir+input_file_name+'_bs'+batch_size_str+'.csv'
    deviation_file = output_dir+input_file_name+'_bs'+batch_size_str+'_deviations.csv'
    figure_file = output_dir+input_file_name+'_bs'+batch_size_str+'.png'
    ...
    plot_learning_curves(history, figure_file.replace('.png', '_history.png'), show_plot=False)
